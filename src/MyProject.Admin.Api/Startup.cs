...
using MyProject.Admin.Api.Configuration.Authorization;
...
using MyProject.Admin.Api.Resources;
...
using MyProject.Shared.Dtos;
using MyProject.Shared.Dtos.Identity;

namespace MyProject.Admin.Api
{
